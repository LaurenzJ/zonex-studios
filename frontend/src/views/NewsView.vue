    ...
    <div class="grid place-items-center px-6">
      ...
      <div v-show="!showModal" class="container my-24 px-6 mx-auto">
        <section class="mb-32 text-gray-300 text-center md:text-left">
          ...
          <div
            class="grid md:grid-cols-2 gap-x-6 xl:gap-x-12 items-center mb-12"
          >
            <div class="mb-6 md:mb-0">
              <div
                ...
                @click="
                  showImage(
                    'https://imgs.stargazete.com/imgsdisk/maintmps/2022/05/18/zonex-network-ilk-tohum-y-614_2-41.jpg'
                  )
                "
              ...
              >
                <img
                  src="https://imgs.stargazete.com/imgsdisk/maintmps/2022/05/18/zonex-network-ilk-tohum-y-614_2-41.jpg"
                  class="w-full"
                  alt=""
                />
                <a href="#!">
            ...
            <div class="mb-6 md:mb-0">
              <h3 class="text-2xl font-bold mb-3">
                Zonex Network received its first seed investment!
              </h3>
              <div
              ...
              <p class="text-gray-500 mb-6">
                <small
                  >Published <u>18.05.2022</u> by
                  <a href="https://star.com.tr" class="text-gray-300">star.com.tr</a></small
                >
              </p>
              <p class="text-gray-500">
                Investment news that comes with the successful exits of our
                domestic companies, which are developing in our country as well
                as the world, continues to be a beacon of hope for our readers.
                Zonex Network, which produces mobile applications, PC & mobile
                games as well as new generation social media ads, received a
                seed investment of 6 million TL.
              </p>
            </div>
          </div>
            ...
            <div class="mb-6 md:mb-0 md:order-1">
              ...
              <p class="text-gray-500 mb-6">
                <small
                  ...
                  <a href="" class="text-gray-900">Joe Biden</a></small
                >
              </p>
              <p class="text-gray-500">
